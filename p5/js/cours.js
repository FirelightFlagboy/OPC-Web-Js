...
var boutonElt1 = document.getElementById("bouton1");
// Ajout d'un gestionnaire pour l'événement click
boutonElt1.addEventListener("click", clic);
// Suppression du gestionnaire pour l'événement click

boutonElt1.removeEventListener("click", clic);
// Ajout d'un gestionnaire qui affiche le type et la cible de l'événement
document.getElementById("bouton2").addEventListener("click", function (e) {
