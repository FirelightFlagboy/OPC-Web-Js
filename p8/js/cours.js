...
ajaxGet("http://localhost/javascript-web-srv/data/langages.txt", display);
...
ajaxGet("http://localhost/javascript-web-srv/data/langages.txt", function (reply) {
	// split la reponse
	let langages = reply.split(';');
	// recupere l'element ul
	let ul = document.getElementById('langages');
	langages.forEach((lg) => {
